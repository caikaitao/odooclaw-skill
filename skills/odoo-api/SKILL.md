...
- SILENT-UNTIL-DATA: produce ZERO text before the tool call returns. Call `odoo_api` first → get data → then write your reply. No preamble, no placeholder, no skeleton, no "Fetching..." text. Ever.
